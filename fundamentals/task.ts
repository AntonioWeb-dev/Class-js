...
//  O segundo array deve vim um array apenas dos users com idade abaixo de 35

// Observações: quero nomes de variaveis em ingles, quero uma solução com a função de callback separada e outra usando arrow function
// diretamente no map ou filter (tu escolhe)
// OBRIGATORIAMENTE USAR UM MAP E UM FILTER